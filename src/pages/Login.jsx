            ...
            <form onSubmit={handleLogin} className="space-y-4 relative">
              ...
              <div className="mt-4 p-3 rounded-xl bg-white/3 border border-white/8">
                ...
                <div className="space-y-1">
                  {[
                    { email: 'admin@hrportal.com',    password: 'admin123',     label: 'Admin',          icon: ShieldCheck, color: 'text-slate-400' },
                    { email: 'depthead@hrportal.com', password: 'depthead123',  label: 'Dept. Head',     icon: UserCircle2, color: 'text-slate-400' },
                    { email: 'hr@hrportal.com',       password: 'hr123456',     label: 'HR',             icon: UserCircle2, color: 'text-accent' },
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  {[
                    ...
                    { role: 'hr',              label: 'HR',            sub: 'Manage recruitment',   icon: UserCircle2, active: 'bg-accent/15 border-accent/40 text-accent' },
                    { role: 'interviewer',     label: 'Interviewer',   sub: 'Confirm slots',        icon: UserCircle2, active: 'bg-accent/15 border-accent/40 text-accent' },
                    { role: 'admin',           label: 'Admin',         sub: 'Full access',          icon: ShieldCheck, active: 'bg-slate-600/15 border-slate-600/40 text-slate-400' },
