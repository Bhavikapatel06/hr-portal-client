...
export const MATCH_COLORS = {
  Strong:  { text: 'text-accent',      bg: 'bg-accent/10',      border: 'border-accent/25',      ring: '#4F8EF7' },
  Good:    { text: 'text-accent/85',   bg: 'bg-accent/5',       border: 'border-accent/15',      ring: '#4F8EF7' },
  Partial: { text: 'text-slate-300',   bg: 'bg-white/5',        border: 'border-white/10',       ring: '#94a3b8' },
  Low:     { text: 'text-slate-400',   bg: 'bg-white/5',        border: 'border-white/8',        ring: '#64748b' },
};
